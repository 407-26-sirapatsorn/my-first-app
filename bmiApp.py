...
weight = st.number_input("กรอกน้ำหนักของคุณ (กิโลกรัม):", min_value=0.0, step=0.1)
height_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมตร):", min_value=0.0, step=0.1)
...
st.divider()
st.write("นางสาวศิรภัสสร คชยวง เลขที่ 26 ม.4/7")
